...
import { useGalleryUpdateForm } from "./useGalleryUpdateForm";
...
export default function GalleryUpdateForm({ updateGallery, gallery }: Props) {
  const { errors, register, handleSubmit, control } = useGalleryUpdateForm({
    updateGallery,
    gallery,
  });

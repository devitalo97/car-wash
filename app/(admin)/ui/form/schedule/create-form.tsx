...
export default function ScheduleCreateForm({ createSchedule }: Props) {
  const { errors, register, handleSubmit } = useScheduleCreateForm({
    createSchedule,
  });
  return (
    <aside className="bg-gray-900 border-l border-white/5">
      ...
      <form className="px-4 py-2 space-y-2 lg:max-w-sm" onSubmit={handleSubmit}>
